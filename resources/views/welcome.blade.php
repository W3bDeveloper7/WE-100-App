...
<head>
    ...
    <link rel="shortcut icon" href="{{URL::asset('front/images/fav.png')}}" />
...
<div class="header-section">
    ...
    <div id="home" class="header">
        <div class="container">
            <div class="top-header">
                <div class="logo">
                    <a href="#"><img src="{{URL::asset('front/images/logo.png')}}" title="logo" /></a>
                </div>
                <!----start-top-nav---->
                <nav class="top-nav">
                    <ul class="top-nav">
                    ...
                    <a href="#" id="pull"><img src="{{URL::asset('front/images/nav-icon.png')}}" title="menu" /></a>
                </nav>
    ...
    <div  id="top" class="callbacks_container">
        <ul class="rslides" id="slider4">
            <li>
                <img src="{{URL::asset('front/images/slide.jpg')}}" alt="">
    ...
    <div class="divice-demo">
        <img src="{{URL::asset('front/images/divice-in-hand.png')}}" title="demo" />
    </div>
    <!---//divice----->
    <!----- //End-slider---->
</div>
...
<div id="fea" class="features">
        ...
        <div class="features-grids">
            ...
            <div class="col-md-4 features-grid">
                <div class="big-divice">
                    <img src="{{URL::asset('front/images/divice.png')}}" title="features-demo" />
                </div>
            </div><!---end-features-grid---->
            <div class="col-md-4 features-grid">
                <div class="features-grid-info">
        ...
        <div class="sreen-gallery-cursual">
            ...
            <div class="container">
                <div id="owl-demo" class="owl-carousel">
                    <div class="item">
                        <img class="lazyOwl" data-src="{{URL::asset('front/images/screen.jpg')}}" alt="screen-name">
                    </div>
                    <div class="item">
                        <img class="lazyOwl" data-src="{{URL::asset('front/images/screen.jpg')}}" alt="screen-name">
                    </div>
            ...
            <div class="container">
                <div class="col-md-3 team-member">
                    <div class="team-member-info">
                        <img class="member-pic" src="{{URL::asset('front/images/team-member4.jpg')}}" title="name" />
                ...
                <div class="col-md-3 team-member">
                    <div class="team-member-info">
                        <img class="member-pic" src="{{URL::asset('front/images/team-member1.jpg')}}" title="name" />
                ...
                <div class="col-md-3 team-member">
                    <div class="team-member-info">
                        <img class="member-pic" src="{{URL::asset('front/images/team-member2.jpg')}}" title="name" />
                ...
                <div class="col-md-3 team-member">
                    <div class="team-member-info">
                        <img class="member-pic" src="{{URL::asset('front/images/team-member3.jpg')}}" title="name" />
    ...
    <div class="test-monials text-center">
        <div class="container">
            <span><img src="{{URL::asset('front/images/icon1.png')}}" title="quit"/></span>
            <script>
                $(document).ready(function() {
            ...
            <div id="owl-demo1" class="owl-carousel">
                <div class="item">
                    ...
                    <div class="quit-people">
                        <img src="{{URL::asset('front/images/quit-people.jpg')}}" title="name" />
    ...
    <div class="featured">
        ...
        <div id="owl-demo2" class="owl-carousel">
            <div class="item">
                <img src="{{URL::asset('front/images/brand-logo1.png')}}" title="the verge" />
            </div>
            <div class="item">
                <img src="{{URL::asset('front/images/brand-logo2.png')}}" title="Mashable" />
            </div>
            <div class="item">
                <img src="{{URL::asset('front/images/brand-logo3.png')}} title="TNW" />
            </div>
            <div class="item">
                <img src="{{URL::asset('front/images/brand-logo4.png')}}" title="bribble" />
            </div>
            <div class="item">
                <img src="{{URL::asset('front/images/brand-logo5.png')}}" title="the verge" />
            </div>
            <div class="item">
                <img src="{{URL::asset('front/images/brand-logo6.png')}}" title="the verge" />
            </div>
            <div class="item">
        ...
        <div class="container">
            ...
            <div class="col-md-2 getintouch-left">
                <div class="footer-divice">
                    <img src="{{URL::asset('front/images/divice-half.png')}}" title="getintouch" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="footer-grids">
                <div class="col-md-3 footer-grid about-info">
                    <a href="#"><img src="{{URL::asset('front/images/logo.png')}}" title="Umbrella" /></a>
                ...
                <div class="col-md-3 footer-grid copy-right">
                    ...
                    <p class="copy">Reserved To <a href="http://cat.com.eg">CAT - Creative Advertising Thinking</a></p>
                </div>
                <div class="clearfix"> </div>
                <script type="text/javascript">
                    $(document).ready(function() {
